...
exports.parseDetectorOutput = exports.runkDetector = void 0;
const child_process_1 = require("child_process");
function runkDetector(cargoDir, dType) {
    const newEnv = Object.assign({}, process.env);
    const child = (0, child_process_1.spawnSync)(`cd ${cargoDir} && cargo clean && cargo +nightly-2022-01-27 lock-bug-detect ${dType}`, { shell: true, env: newEnv });
    return child.stdout.toString();
}
exports.runkDetector = runkDetector;
// VSCode -> extension -> LSP -> cargo check (our code) -> parse stdout -> return LSP receiver
function parseDetectorOutput(s) {
    let lines = s.split("\n");
    // state:
    // 0: start
    // 1: first lock type
...
exports.parseDetectorOutput = parseDetectorOutput;
